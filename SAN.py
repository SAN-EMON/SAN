...
def crack(idf,pwv):
    ...
    # 'cookie': 'datr=htvvZBYT0qQaxB9AuLnajZM-; sb=htvvZL5vM0Hamzce3UP0tfSy; m_pixel_ratio=4; wd=360x694; fr=0bz1b1rIyY4N4pJ8S..Bk79uG.At.AAA.0.0.Bk79uq.AWVyNx7rX6U',
    'dpr': '4',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.72"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"HD1925"',
